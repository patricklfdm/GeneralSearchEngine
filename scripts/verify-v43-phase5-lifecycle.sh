...
if [[ "$skip_build" == false ]]; then
    ./mvnw -q \
        -Dtest=V43LifecycleHardeningPhase5Test,V43TextImagesPhase4Test,V43StructuredImagesPhase3Test,V43DerivedFormatPhase2Test \
        test
fi
...
work_dir=$(mktemp -d "${TMPDIR:-/tmp}/gse-v43-phase5.XXXXXX")
...
terminations=(internal-halt external-kill internal-halt)
...
echo "V4.3 Phase 5 lifecycle, cleanup and cross-version hardening: PASS"
