...
class Worker:
    def __init__(self, root, node, cp, history, generation=1, consumer='qualification', *, jvm_arguments=()):
        self.root = root
        ...
        self.proc = subprocess.Popen(['java', *jvm_arguments, '-cp', cp, PACKAGE + 'replication.V51PublicWorker', str(root), node[-1], consumer, str(generation)],
