...
REQUIRED=('PHASE_0_CONTRACT.md','PHASE_0_ENTRY_PLAN.md','LEADERSHIP_AND_RECOVERY.md',
          ...
          'PHASE_6_FULL_SIZE.md','PHASE_6_FULL_SIZE_RUNTIME.md','PHASE_6_CLOUD_CONTROL.md','PHASE_6_CLOUD_PROVIDER.md','PHASE_6_GUEST_SERVICE.md','PHASE_6_GUEST_BOOTSTRAP.md','PHASE_6_GUEST_STARTUP.md','PHASE_6_GUEST_DELIVERY.md')
