...
REQUIRED=('PHASE_0_CONTRACT.md','PHASE_0_ENTRY_PLAN.md','LEADERSHIP_AND_RECOVERY.md',
          ...
          'PHASE_4_PUBLIC_PROTOCOL.md','PHASE_4_PUBLIC_RECLAMATION.md','PHASE_4_PUBLIC_BOUNDS.md',
          'PHASE_4_PUBLIC_PROMISES.md','PHASE_4_PUBLIC_CANDIDATES.md','PHASE_4_PUBLIC_PRESSURE.md',
          'PHASE_4_RESOURCE_LIMITS.md','PHASE_4_BACKPRESSURE.md','PHASE_4_PUBLIC_SELECTION.md','PHASE_4_LIFECYCLE_HARDENING.md',
          'PHASE_4_FINAL_COVERAGE.md','PHASE_4_EVIDENCE_STATUS.md','PHASE_4_CHECKLIST.md',
          'PHASE_5_ENTRY_PLAN.md','PHASE_5_COMBINED_RECOVERY.md','PHASE_5_COMBINED_LIFECYCLE.md','PHASE_5_CHECKLIST.md',
          'PHASE_5_ACCEPTANCE.md','PHASE_5_EVIDENCE_LEDGER.md','PHASE_6_ENTRY_PLAN.md',
          'PHASE_6_LOCAL_MEASUREMENT_PLAN.md','PHASE_6_MODEL_FOUNDATION.md','PHASE_6_CHECKLIST.md',
          'PHASE_6_LOCAL_PERFORMANCE.md','PHASE_6_LOCAL_ACCEPTANCE.md','PHASE_6_CLOUD_WORKLOAD_CONTRACT.md',
          'PHASE_6_FULL_SIZE.md','PHASE_6_FULL_SIZE_RUNTIME.md','PHASE_6_CLOUD_CONTROL.md','PHASE_6_CLOUD_PROVIDER.md','PHASE_6_GUEST_SERVICE.md','PHASE_6_GUEST_BOOTSTRAP.md','PHASE_6_GUEST_STARTUP.md','PHASE_6_GUEST_DELIVERY.md','PHASE_6_GUEST_DEADLINES.md','PHASE_6_ROOT_ADMISSION.md')
