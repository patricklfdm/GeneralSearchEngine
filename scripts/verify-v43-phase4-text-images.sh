...
if [[ "$skip_build" == false ]]; then
    ./mvnw -q \
        -Dtest=V43TextImagesPhase4Test,V43StructuredImagesPhase3Test,V43DerivedFormatPhase2Test \
        test
fi
...
work_dir=$(mktemp -d "${TMPDIR:-/tmp}/gse-v43-phase4.XXXXXX")
...
echo "V4.3 Phase 4 text images and complete selective fallback: PASS"
