...
/** Measures publication when both posting and document-length metadata change. */
...
public class RankedMetadataPublicationBenchmark {
    ...
    public void setUp() {
        ...
        for (int docId = 0; docId < vocabularySize; docId++) {
            ...
            replacement[docId] = new TextDocument(
                    "stable replacement" + docId + " extra extra");
    ...
    @Benchmark
    public long publishPostingAndLengthChanges() {
        ...
        return current.totalDocumentLength();
    }
