...
- **Status:** V5.0 published and reconciled; V5.1 Phase 1 accepted; Phase 2A storage implemented locally; V5.2–V5.4 planned
...
[Phase 2 storage](v5.1/PHASE_2_ENTRY_PLAN.md); Batch A is implemented, with public runtime disabled.
