...
- **Status:** V5.0 published and independently verified; V5.1 Phase 3 accepted; Phase 4A/B/C accepted; Phase 4D public fault matrix in progress; V5.2-V5.4 planned
