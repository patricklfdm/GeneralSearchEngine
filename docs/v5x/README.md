...
- **Status:** V5.0 published and independently verified; V5.1 Phase 3 accepted; Phase 4A/B/C/D accepted; Phase 4E recovery/lifecycle in progress; V5.2-V5.4 planned
