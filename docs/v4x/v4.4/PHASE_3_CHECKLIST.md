...
- **Status:** Complete — accepted through protected PR #136
...
- [x] Phase 3 PR #136 passed required checks.
- [x] Phase 3 merged through protected `master` as `b04e1e3`.
- [x] Exact-master CI run `34626677031` passed before Phase 4.
