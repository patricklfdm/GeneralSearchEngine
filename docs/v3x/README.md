...
- [`v3.2/`](v3.2/PHASE_0_CHECKLIST.md) freezes the additive offset-capable analyzer and
  ...
  local gates are accepted. Signed `v3.2.0`, Maven Central publication, clean remote
...
- [`v3.4/`](v3.4/PHASE_0_CHECKLIST.md) freezes the final in-memory hardening line
  ...
  [Phase 1](v3.4/PHASE_1_CHECKLIST.md) is accepted through PR #68 at
  ...
  an open V3.4 exit gate. [Phase 3](v3.4/PHASE_3_CHECKLIST.md) is accepted through PR
