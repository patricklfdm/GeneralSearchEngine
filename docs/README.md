...
- [V5.1 Phase 3B real TCP runtime and V4 application path](v5x/v5.1/PHASE_3_RUNTIME.md)
...
- [V5.1 Phase 4E public recovery and lifecycle qualification](v5x/v5.1/PHASE_4_PUBLIC_RECOVERY.md)
...
- [V5.1 Phase 4O pinned recovery, partial I/O and repeated timeouts](v5x/v5.1/PHASE_4_LIFECYCLE_HARDENING.md)
...
- [V5.0 Phase 3 entry plan](v5x/v5.0/PHASE_3_ENTRY_PLAN.md)
...
- [V5.0 public-admission Step C public runtime](v5x/v5.0/PUBLIC_ADMISSION_RUNTIME.md)
- [V5.0 Phase 6 performance and cloud entry plan](v5x/v5.0/PHASE_6_ENTRY_PLAN.md)
- [V5.0 Phase 6A local performance and evidence](v5x/v5.0/PHASE_6_LOCAL_PERFORMANCE.md)
- [V5.0 Phase 6 cloud baseline](v5x/v5.0/PHASE_6_BASELINE.md)
- [V5.0 Phase 6 canonical review](v5x/v5.0/PHASE_6_CANONICAL_REVIEW.md)
- [V5.0 Phase 6 checklist](v5x/v5.0/PHASE_6_CHECKLIST.md)
...
- [V4.4 Phase 1 foundation baseline](v4x/v4.4/PHASE_1_BASELINE.md)
- [V4.4 Phase 1 checklist](v4x/v4.4/PHASE_1_CHECKLIST.md)
- [V4.4 Phase 1 machine-readable plan](v4x/v4.4/phase1-plan.json)
- [V4.4 canonical release toolchain](v4x/v4.4/release-toolchain.json)
- [V4.4 Phase 2 local matrix baseline](v4x/v4.4/PHASE_2_BASELINE.md)
- [V4.4 Phase 2 checklist](v4x/v4.4/PHASE_2_CHECKLIST.md)
- [V4.4 Phase 2 execution map](v4x/v4.4/phase2-execution.json)
- [V4.4 Phase 3 zero-change decision](v4x/v4.4/PHASE_3_BASELINE.md)
- [V4.4 Phase 3 checklist](v4x/v4.4/PHASE_3_CHECKLIST.md)
- [V4.4 Phase 3 admission record](v4x/v4.4/phase3-admission.json)
- [V4.4 Phase 4 local hardening baseline](v4x/v4.4/PHASE_4_BASELINE.md)
- [V4.4 Phase 4 checklist](v4x/v4.4/PHASE_4_CHECKLIST.md)
- [V4.4 Phase 5 stabilization baseline](v4x/v4.4/PHASE_5_BASELINE.md)
- [V4.4 Phase 5 cloud readiness](v4x/v4.4/PHASE_5_CLOUD_READINESS.md)
- [V4.4 Phase 5 checklist](v4x/v4.4/PHASE_5_CHECKLIST.md)
- [V4.4 Phase 6 performance and evidence](v4x/v4.4/PHASE_6_PERFORMANCE_AND_EVIDENCE.md)
...
- [V4.4 API and storage compatibility](v4x/v4.4/API_COMPATIBILITY.md)
...
- [V4.3 Phase 2 derived format and inspection](v4x/v4.3/PHASE_2_DERIVED_FORMAT_AND_INSPECTION.md)
- [V4.3 Phase 2 local baseline](v4x/v4.3/PHASE_2_BASELINE.md)
- [V4.3 Phase 2 checklist](v4x/v4.3/PHASE_2_CHECKLIST.md)
...
- [V4.2 Phase 6 performance and evidence](v4x/v4.2/PHASE_6_PERFORMANCE_AND_EVIDENCE.md)
- [V4.2 Phase 6 evidence baseline](v4x/v4.2/PHASE_6_BASELINE.md)
...
## v3.x — completed in-memory line and compatibility baseline
...
- [V3.2 Phase 3 checklist](v3x/v3.2/PHASE_3_CHECKLIST.md)
...
- [V3.3 Phase 3 checklist](v3x/v3.3/PHASE_3_CHECKLIST.md)
...
- [V3.4 Phase 4 checklist](v3x/v3.4/PHASE_4_CHECKLIST.md)
...
- [Cloud benchmark selection and cost guide](v3/CLOUD_BENCHMARK_SELECTION_GUIDE.md)
...
- [V3 canonical cloud baseline results](v3/CLOUD_CANONICAL_BASELINE_RESULTS.md)
